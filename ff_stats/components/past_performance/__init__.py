...
def init(nfl_year_param):
    ...
    qb_stats_generator = StatsGenerator(nfl_stats, qb_position, output_year)
    ...
    rb_stats_generator = StatsGenerator(nfl_stats, rb_position, output_year)
    ...
    wr_stats_generator = StatsGenerator(nfl_stats, wr_position, output_year)
    ...
    te_stats_generator = StatsGenerator(nfl_stats, te_position, output_year)
