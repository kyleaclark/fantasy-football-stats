...
advanced_stats.calc_plyr(qb_list, config['sample_size'])
...
advanced_stats.calc_plyr(rb_list, config['sample_size'])
...
advanced_stats.calc_plyr(wr_list, config['sample_size'])
...
advanced_stats.calc_plyr(te_list, config['sample_size'])
