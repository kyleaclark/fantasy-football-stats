...
export_list.export_to_csv(qb_list, '2016_qb.csv')
...
export_list.export_to_csv(rb_list, '2016_rb.csv')
...
export_list.export_to_csv(wr_list, '2016_wr.csv')
...
export_list.export_to_csv(te_list, '2016_te.csv')
