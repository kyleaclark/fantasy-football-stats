...
auction_qb_df = pd.DataFrame(data=None, index=None, columns=None)

for column in qb_2016:
    column_name = csv_column_map[column]
    if column_name == 'Player':
        auction_qb_df[column_name] = qb_2016[column]
    elif column_name == 'AuctionValue':
        auction_qb_df[column_name] = qb_2016[column]

auction_qb_df['Position'] = 'qb'
...
#
#     df_2014[column_name] = qb_2014[column]
#
# qb_2013 = pd.read_csv('../../output/2015/2015_qb.csv')
# df_2013 = pd.DataFrame(data=None, index=None, columns=None)
#
# for column in qb_2013:
#     column_name = csv_column_map[column]
#
#     if column_name == None:
#         continue
...
#
#     df_2013[column_name] = qb_2013[column]
#
...
auction_df = auction_qb_df.merge(auction_rb_df, on=['Player', 'Position', 'AuctionValue'], how='outer')
...
# print (output_df['AuctionValue'])

output_df.to_csv('fantasy_data2.csv')
